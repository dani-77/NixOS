...
appmenu.Accessories = {
    ...
    { 'QtFM', 'qtfm', '/usr/share/icons/hicolor/128x128/apps/qtfm.png' },
...
appmenu.MultiMedia = {
    ...
    { 'Volume Control', 'pavucontrol', '/usr/share/icons/hicolor/scalable/apps/org.pulseaudio.pavucontrol.svg' },
...
appmenu.Settings = {
    ...
    { 'Better Control', '/usr/bin/better-control' },
